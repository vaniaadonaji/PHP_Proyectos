...
<div class="container pb-6 pt-6">
    <?php
        ...
        // Si la variable de sesion llamada busqueda_producto NO viene definida y esta vacia entonces:
    ...
    <?php 
        // Sino: Si la variable de sesion llamada busqueda_producto SI viene definida y NO esta vacia entonces:
        }else{ 
    ?>
    <div class="columns">
        <div class="column">
    ...
    <?php
            ...
            if(isset($_GET['product_id_del'])){
                // Incluimos el contenido del archivo producto_eliminar.php
